...
function MeetingDetails() {
  ...
  const { title, url, personCount, description, users } = useSelector(
    (state: RootState) => state.meetings.meeting
  );

  const roles = useSelector((state: RootState) => state.meetings.meeting.role);
